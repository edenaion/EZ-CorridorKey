...
[![リリース](https://img.shields.io/badge/Release-v2.1.3-FFF203?style=flat-square&labelColor=141300)](https://github.com/edenaion/EZ-CorridorKey/releases/latest)
...
> **最新リリース: [v2.1.3](https://github.com/edenaion/EZ-CorridorKey/releases/tag/v2.1.3):** Windows 向けのホットフィックスです。アクセント記号や非ラテン文字を含むユーザーフォルダーでの AI アルファ生成を修正し ([#184](https://github.com/edenaion/EZ-CorridorKey/issues/184))、CLI インストーラーの FFmpeg チェックを修復し、インストールガイドに新しいビデオチュートリアルへのリンクを追加しました。[完全な changelog](../../CHANGELOG.md) を参照してください。
...
> v2.0.0 とソースインストールに適用されます。2.1.3 のようなパッチリリースはアプリ内自動更新として提供され、新しい Mac インストーラーは含まれません。
