...
[![リリース](https://img.shields.io/github/v/release/edenaion/EZ-CorridorKey?style=flat-square&label=Release&labelColor=141300&color=FFF203)](https://github.com/edenaion/EZ-CorridorKey/releases/latest)
...
> **最新リリース: [v2.0.0](https://github.com/edenaion/EZ-CorridorKey/releases/tag/v2.0.0)** - ブルーバックキーイング、chroma key のスポイト、VideoMaMa マスク読み込み、i18n 対応。詳しくは[完全な changelog](../../CHANGELOG.md)を参照してください。
...
> **既知の問題:** MLX の FG 出力は、ブロック状またはアーティファクトのある結果を生成する場合があります。FG 出力を無効にし、代わりに Matte + Processed 出力を使用してください。CUDA ユーザーには影響しません。
...
**現在の言語:** 英語 (内蔵)。あなたの言語をここに追加したい場合は PR を歓迎します。
