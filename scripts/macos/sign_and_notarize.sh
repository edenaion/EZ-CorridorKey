...
VERSION=$(grep 'CFBundleShortVersionString' "$ROOT/corridorkey-macos.spec" | head -1 | grep -o "'[0-9.]*'" | tr -d "'")
VERSION="${VERSION:-1.8.0}"
PKG_NAME="CorridorKey-${VERSION}.pkg"
...
ZIP_PATH="$ROOT/dist/CorridorKey.zip"
